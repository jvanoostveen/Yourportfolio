...
//******************************************************************************
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwArrMonthNames       = ['jan','feb','maa','apr','mei','jun',
                                       'jul','aug','sep','okt','nov','dec'];
             scwArrWeekInits        = ['zo','ma','di','wo','do','vr','za'];
             scwInvalidDateMsg      = 'De ingevoerde datum is ongeldig.\n';
             scwOutOfRangeMsg       = 'De ingevoerde datum is buiten bereik.';
             scwDoesNotExistMsg     = 'De ingevoerde datum bestaat niet.';
             scwInvalidAlert        = ['Ongeldige datum (',') is genegeerd.'];
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #999999;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #999999;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #666666;'   +
                                        'color:             #FFFFFF;'  +
                                        'font-weight:       bold;}'  +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #AAAAAA;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #FFFFFF;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  #AAAAAA;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #FFFFFF;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #AAAAAA;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #FFFFFF;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #AAAAAA;'   +
                                        'cursor:            pointer;'   +
                                        'cursor:            hand;'      +
                                        'color:             #FFFFFF;}'  +
            '/* Today selector */'                                      +
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSourceEle)
        {scwTriggerEle = scwSourceEle;
         ...
         if (scwDateValue.length==0 || scwDateValue == '00-00-0000')
...
// ***************************
    ...
    document.write(
     "<!--[if IE]>" +
        "<iframe class='scw' src='design/scripts/scwblank.html' " +
