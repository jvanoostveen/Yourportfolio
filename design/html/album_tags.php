...
<?php foreach( $group['tags'] as $tag ) : ?>
	<input type="checkbox" name="albumForm[album][tags][<?php echo $tag['id']; ?>]" id="t_<?php echo $tag['id']; ?>" <?=( in_array( $tag['id'], array_values( $album->tags ) ) ) ? "checked=checked" : ""?>><label for="t_<?php echo $tag['id']; ?>"> <?php echo $tag['tag']; ?></label><br>
<?php endforeach; ?>
</div>
<?php endforeach; ?>
		</div>
