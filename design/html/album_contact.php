...
<tr>
	<td nowrap align="right">&nbsp;</td>
	<td><b><?=gettext('e-mail gegevens')?></b></td>
	<td>&nbsp;</td>
</tr>
<tr>
	<td nowrap align="right"><?=gettext('onderwerp')?>:</td>
	<td>
	<input type="hidden" name="albumForm[album][parameters][subject][id]" value="<?=$album->getParameter('subject', 'id')?>">
	<input type="text" name="albumForm[album][parameters][subject][value]" id="mail" value="<?=$canvas->edit_filter($album->getParameter('subject'))?>" size="40">
	</td>
	<td>&nbsp;</td>
</tr>
<tr>
	...
	<td>
	<input type="hidden" name="albumForm[album][parameters][name][id]" value="<?=$album->getParameter('name', 'id')?>">
	<input type="text" name="albumForm[album][parameters][name][value]" id="mail" value="<?=$canvas->edit_filter($album->getParameter('name'))?>" size="40">
	</td>
	<td>&nbsp;</td>
</tr>
<tr>
	...
	<td>
	<input type="hidden" name="albumForm[album][parameters][mail][id]" value="<?=$album->getParameter('mail', 'id')?>">
	<input type="text" name="albumForm[album][parameters][mail][value]" id="mail" value="<?=$canvas->edit_filter($album->getParameter('mail'))?>" size="40">
	</td>
	<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="albumForm[album][name]" id="title" value="<?=$canvas->edit_filter($album->name)?>" size="40"></td>
	<td>&nbsp;</td>
</tr>
<tr>
...
<? endif; /* end show multilingual edit */ ?>
<tr>
	<td nowrap align="right">&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
