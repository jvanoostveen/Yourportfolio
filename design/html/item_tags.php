...
<?php foreach( $group['tags'] as $tag ) : ?>
	<input type="checkbox" name="itemForm[item][tags][<?php echo $tag['id']; ?>]" id="t_<?php echo $tag['id']; ?>" <?=( in_array( $tag['id'], array_values( $item->tags ) ) ) ? "checked=checked" : ""?>><label for="t_<?php echo $tag['id']; ?>"> <?php echo $tag['tag']; ?></label><br>
<?php endforeach; ?>
</div>
<?php endforeach; ?>
		</div>
